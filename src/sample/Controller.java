...
public class Controller {
    ...
    @FXML
    void initialize() {
        getData.setOnAction(even -> {
            String getUserCity = city.getText().trim();
            if (!getUserCity.equals("")) {
                String output = getUrlContent("http://api.openweathermap.org/data/2.5/weather?q="+getUserCity+"&appid=2cf5f4a4b6c576926ae7177032a3d282&units=metric");
    ...
    private static String getUrlContent(String urlaAdress) {
